...
<?php
	...
	$query = "INSERT INTO bookings VALUES ('$bookingRef', '$fName', '$lName', '$address', '$mNumber', '$suburb', '$destSub', '$aDate', '$aTime', '$bookingDate', '$status', '$pickUpTimeAndDate')";
	$queryResult = mysqli_query($db,$query); 
